"""
This code is provided by Woonhyuk Baek, Kakao Brain.
"""
...
class ImageNet(torchvision.datasets.ImageFolder):
    ...
    def __init__(self, root, split='train', download=False, cache_path=None, **kwargs):
    ...
    def __getitem__(self, index):
        sample = None
        if self.cache_path:
            _filepath = self.cache_path.replace('0000000000', '%010d' % index)
        ...
        if sample is None:
            sample, target = super(ImageNet, self).__getitem__(index)
