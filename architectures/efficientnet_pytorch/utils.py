...
GlobalParams = collections.namedtuple('GlobalParams', [
    ...
    'depth_divisor', 'min_depth', 'drop_connect_rate', 'image_size', 'multiple_feat'])
...
def drop_connect2(inputs, drop_p, training):
    """ Drop connect. """
    if not training:
...
def get_model_params(model_name, override_params):
    ...
    if 'efficientnet-l2t' in model_name:
        drop_connect_rate = C.get()['dropconn']
    ...
    blocks_args, global_params = efficientnet(
        width_coefficient=w, depth_coefficient=d, dropout_rate=p, image_size=s, drop_connect_rate=drop_connect_rate)
